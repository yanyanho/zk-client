...
import python_web3.eth_abi
from python_web3.eth_abi.exceptions import (
    ParseError,
)
from python_web3.eth_abi.grammar import (
    BasicType,
    parse,
)
from python_web3.eth_utils import (
    to_checksum_address,
)
from python_web3.eth_utils.address import (
    is_binary_address,
)
from python_web3.eth_utils.toolz import (
    curry,
)
...
from python_web3.utils.encoding import (
    hexstr_if_str,
    text_if_str,
    to_bytes,
    to_hex,
...
from python_web3.utils.validation import (
    validate_abi,
    validate_address,
)
from python_web3.utils.exceptions import (
    InvalidAddress,
)
...
if LooseVersion(python_web3.eth_abi.__version__) < LooseVersion("2"):
