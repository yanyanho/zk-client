...
import os
from python_web3.eth_utils.crypto import set_crypto_type, CRYPTO_TYPE_GM, CRYPTO_TYPE_ECDSA
...
class client_config:
    ...
    contract_info_file = "python_web3/bin/contract.ini"  # 保存已部署合约信息的文件
    ...
    logdir = "python_web3/bin/logs"  # 默认日志输出目录，该目录必须先建立
